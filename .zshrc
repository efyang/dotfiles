...
alias update-mirrors="sudo reflector --verbose --country 'United States'  -l 30 -p http --sort rate --threads 1 --save /etc/pacman.d/mirrorlist && yaourt -Syy"
...
export RUSTDOCFLAGS="--extend-css $HOME/scripts/rustdoc_ayu.css"
#eval "$(nodenv init -)"
alias cloc=tokei
alias grep=rg
alias ls=exa
