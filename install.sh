...
yaourt -S firefox-developer freshplayerplugin i3-gaps-next-git dmenu2 albert atom-editor-bin libtinfo skippy-xd-git sublime-text-dev photoqt tor-browser-en thermald lightdm-webkit-theme-material-git gtk-arc-flatabulous-theme-git discord-canary downgrade kwplayer screencloud emojione-color-font xfce4-volumed-pulse jdownloader2 tilp --noconfirm
